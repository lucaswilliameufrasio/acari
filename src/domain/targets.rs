...
pub const OS_CACHES: &[CleanTarget] = &[
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/CocoaPods"),
        description: Cow::Borrowed("CocoaPods pod downloads"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/org.swift.swiftpm"),
        description: Cow::Borrowed("Swift Package Manager caches"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Logs/DiagnosticReports"),
        description: Cow::Borrowed("Crash reports and diagnostics dumps"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/bun"),
        description: Cow::Borrowed("Bun package manager cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/deno"),
        description: Cow::Borrowed("Deno module cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/.nuget/packages"),
        description: Cow::Borrowed(".NET package cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/.cargo/git"),
        description: Cow::Borrowed("Cargo git dependency checkouts"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/com.spotify.client"),
        description: Cow::Borrowed("Spotify streaming cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/com.tinyspeck.slackmacgap"),
        description: Cow::Borrowed("Slack workspace cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        ...
        path: Cow::Borrowed("~/Library/Caches/com.hnc.Discord"),
        description: Cow::Borrowed("Discord cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
...
pub const OS_CACHES: &[CleanTarget] = &[
    ...
    CleanTarget {
        name: Cow::Borrowed("Spotify Cache"),
        path: Cow::Borrowed("~/.cache/spotify"),
        description: Cow::Borrowed("Spotify streaming cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
    ...
    CleanTarget {
        name: Cow::Borrowed("Discord Cache"),
        path: Cow::Borrowed("~/.cache/discord"),
        description: Cow::Borrowed("Discord cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
