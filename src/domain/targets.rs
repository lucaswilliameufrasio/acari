...
pub const EXTRA_CACHES: &[CleanTarget] = &[
    ...
    CleanTarget {
        name: Cow::Borrowed("Bun Install Cache"),
        path: Cow::Borrowed("~/.bun/install/cache"),
        description: Cow::Borrowed("Bun package download cache"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        name: Cow::Borrowed("Dart Analysis Cache"),
        path: Cow::Borrowed("~/.dartServer"),
        description: Cow::Borrowed("Dart analysis server caches, regenerated on demand"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        name: Cow::Borrowed("FVM Flutter SDKs"),
        path: Cow::Borrowed("~/fvm"),
        description: Cow::Borrowed("Flutter SDK versions managed by FVM (re-downloadable)"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
    ...
    CleanTarget {
        name: Cow::Borrowed("Mise Toolchains"),
        path: Cow::Borrowed("~/.local/share/mise"),
        description: Cow::Borrowed("Mise tool installs; prefer 'mise prune' to keep active ones"),
        command: &[],
        requires_sudo: false,
        dangerous: true,
        delete_entire: false,
    ...
    CleanTarget {
        name: Cow::Borrowed("Android AVD Emulators"),
        path: Cow::Borrowed("~/.android/avd"),
        description: Cow::Borrowed(
            "Emulator device images and their data (recreate with avdmanager)",
        ),
        command: &[],
        requires_sudo: false,
        dangerous: true,
...
pub const OS_CACHES: &[CleanTarget] = &[
    ...
    CleanTarget {
        name: Cow::Borrowed("Android SDK System Images"),
        path: Cow::Borrowed("~/Library/Android/sdk/system-images"),
        description: Cow::Borrowed("Emulator OS images (re-downloadable via sdkmanager)"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
        delete_entire: false,
...
pub const OS_CACHES: &[CleanTarget] = &[
    ...
    CleanTarget {
        name: Cow::Borrowed("Android SDK System Images"),
        path: Cow::Borrowed("~/Android/Sdk/system-images"),
        description: Cow::Borrowed("Emulator OS images (re-downloadable via sdkmanager)"),
        command: &[],
        requires_sudo: false,
        dangerous: false,
